...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noScrapes = __webpack_require__(1);

	var _noScrapes2 = _interopRequireDefault(_noScrapes);

	var _schemaDotOrg = __webpack_require__(24);

	var _schemaDotOrg2 = _interopRequireDefault(_schemaDotOrg);
	...
	if (_schemaDotOrg2.default.test()) {
	   scraped = _schemaDotOrg2.default.scrape();
	}

	if (!scraped) {
	   scraped = _noScrapes2.default.scrape();
	}

	_simple2.default.send(url, scraped, function (suggestions) {
	   ...
	   (0, _jquery2.default)('body').append('<div id="ft-all-roads"></div>');
	   (0, _jquery2.default)('#ft-all-roads').append((0, _ui2.default)(suggestion));

	   window.setTimeout(function () {
	      (0, _jquery2.default)('.ft-all-roads-container').addClass('open');
	   }, 2000);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoOpScraper = {
	   scrape: function scrape() {
	      var bodyContent = (0, _jquery2.default)('body').html();
	      return bodyContent;
	   }
	};

	exports.default = NoOpScraper;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var allRoadsUrl = 'https://dynpub-uk-up.ft.com/__all-roads/__health';

	var Sender = {
	   send: function send(url, content, ok) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "							<a class=\"o-teaser__tag\">"
	    + container.escapeExpression(((helper = (helper = helpers.concept || (depth0 != null ? depth0.concept : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"concept","hash":{},"data":data}) : helper)))
	    + "</a>\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "							<h2 class=\"o-teaser__heading\"><a href=\""
	    + alias4(((helper = (helper = helpers.webUrl || (depth0 != null ? depth0.webUrl : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"webUrl","hash":{},"data":data}) : helper)))
	    + "\">"
	  ...
	  return "							<p class=\"o-teaser__standfirst\">"
	    + container.escapeExpression(((helper = (helper = helpers.standfirst || (depth0 != null ? depth0.standfirst : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"standfirst","hash":{},"data":data}) : helper)))
	    + "</p>\n";
	},"7":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "							<div class=\"o-teaser__timestamp "
	    + alias4(((helper = (helper = helpers.inprogress || (depth0 != null ? depth0.inprogress : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"inprogress","hash":{},"data":data}) : helper)))
	    + "\">\n								<time data-o-component=\"o-date\" class=\"o-date\" datetime=\""
	    + alias4(((helper = (helper = helpers.publishedDate || (depth0 != null ? depth0.publishedDate : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"publishedDate","hash":{},"data":data}) : helper)))
	    + "\">"
	    + alias4(((helper = (helper = helpers.publishedDate || (depth0 != null ? depth0.publishedDate : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"publishedDate","hash":{},"data":data}) : helper)))
	    + "</time>\n							</div>\n";
	  ...
	  return "<link rel=\"stylesheet\" href=\"https://build.origami.ft.com/v2/bundles/css?modules=o-grid@4.3.0,o-fonts@2.2.0,o-colors@3.5.4,o-typography@4.3.2,o-teaser@1.0.0-beta.7\"/>\n<script src=\"https://build.origami.ft.com/v2/bundles/js?modules=o-grid@4.3.0,o-fonts@2.2.0,o-colors@3.5.4,o-typography@4.3.2,o-teaser@1.0.0-beta.7\"></script>\n\n<div class=\"ft-all-roads-container\">\n	<div class=\"o-grid-container\">\n		<div class=\"o-grid-row\">\n			<div data-o-grid-colspan=\"2\">\n				<span><img src=\"//image.webservices.ft.com/v1/images/raw/ftlogo:brand-ft-logo-square?source=hackday-all-roads-plugin\"></img></span>\n			</div>\n			<div data-o-grid-colspan=\"10\">\n				<div class=\"o-teaser o-teaser--small\" data-o-component=\"o-teaser\">\n					<div class=\"o-teaser__content\">\n"
	    ...
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.standfirst : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SchemaDotOrgScraper = {
	   test: function test() {
	      return (0, _jquery2.default)('[itemtype="http://schema.org/Article"]').length > 0 || (0, _jquery2.default)('[itemtype="http://schema.org/NewsArticle"]').length > 0;
	   },
	   scrape: function scrape() {
	      var bodyContent = (0, _jquery2.default)('[itemprop="articleBody"]').text();
	      console.log(bodyContent);
	      return bodyContent;
	   }
	};

	exports.default = SchemaDotOrgScraper;
